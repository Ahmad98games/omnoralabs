...
export const DEFAULT_PROPS: Record<string, ComponentSchema> = {
  ...
  'hero': {
    version: '2.5.0',
    defaultProps: {
      headline: 'INDUSTRIAL KERNEL',
      subheadline: 'High-performance modular commerce operating system.',
  ...
  'split_hero': {
    ...
    defaultProps: {
      ...
      headline: 'INDUSTRIAL ARCHETYPE',
      richText: 'Every entity in our collection tells a story of precision engineering and timeless design.',

                ...
                {order?.paymentMethod !== 'COD' && (
                    <div className="payment-instructions-lux animate-reveal-slow">
                        <div className="wa-header-lux">
                            ...
                            <h3 className="font-serif">Payment Instructions</h3>
                        </div>
                        <div className="instruction-box">
                            <div className="instruction-item">
                                <span className="inst-label">EasyPaisa / JazzCash</span>
                                <span className="inst-value">0309 7613611</span>
                                <span className="inst-sub">Account Title: Hamza Bilal</span>
                            </div>
                            <p className="inst-note">
                                Please send the screenshot of the transaction on WhatsApp or upload it via the link sent to your email.
                            </p>
                        </div>
                    </div>
                )}
